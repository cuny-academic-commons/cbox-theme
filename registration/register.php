			...
			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				...
				<?php if ( bp_is_active( 'xprofile' ) ) : ?>
					...
					<div class="register-section" id="profile-details-section">
						...
						<?php if ( bp_is_active( 'xprofile' ) ) : if ( bp_has_profile( function_exists( 'bp_xprofile_signup_args' ) ? bp_xprofile_signup_args() : array( 'profile_group_id' => 1, 'fetch_field_data' => false ) ) ) : while ( bp_profile_groups() ) : bp_the_profile_group(); ?>
				...
				<div class="submit">
					<input type="submit" name="signup_submit" id="wp-submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
				</div>
