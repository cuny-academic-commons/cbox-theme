 ...
 * @since 1.0
 */ 
class InfinityBPWidget extends WP_Widget {
 
    function InfinityBPWidget() {
          $widget_ops = array( 'classname' => 'infinity_bp_profile_widget', 'description' => __( "Displays a basic member widget" ) );
          $this->WP_Widget('InfinityBPWidget', __('Infinity BP Member Widget'), $widget_ops);
    }
...
add_action('widgets_init', create_function('', 'return register_widget("InfinityBPWidget");'));
?>