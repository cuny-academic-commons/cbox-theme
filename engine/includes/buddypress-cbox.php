 ...
 * @return object
 */
function cbox_theme_xprofile_settings_record_all_group_field_ids( $retval ) {
...
add_filter( 'xprofile_group_fields', 'cbox_theme_xprofile_settings_record_all_group_field_ids' );
